...
export default function ProblemForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await getAiActions(description, " as a Network Support");
  ...
  const problemSubmitHandler = async (e) => {
    ...
    .post("https://getform.io/f/ajjmymda", {
        message: "you have a new problem in Network Maintenance",
    },
  ...
  return (
    <div className="h-[calc(100vh-60px)]">
        <h2 className="text-3xl font-bold my-6 text-white text-center">Network Maintenance</h2>
      {currentUser ? (
